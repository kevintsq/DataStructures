...
typedef struct node {
    char is_word, is_stopword, word[64];
    int cnt1, cnt2;
    struct node *next[26];
} node;
...
static inline node *insert(register node *root, register char *word) {
    register node *p;
    register int index;
...
static inline node *search(register node *root, register char *word) {
    register node *p;
    register int index;
...
static inline int cmp1(const register void *a, const register void *b) {
...
static inline int cmp2(const register void *a, const register void *b) {
...
int main() {
    ...
    register int i = 0, j = 0, cnt = 0, union_sum1 = 0, union_sum2 = 0, sum1 = 0, sum2 = 0, len;
    int n;
    scanf("%d", &n);
    //clock_t t1 = clock();
